...
export default function Stepper({
  ...
  renderStepIndicator,
  finalStepButtonText = "Salva",
  classNameButtonNext = "next-button",
  ...rest
}) {
        ...
        {!isCompleted && (
          <div className={`footer-container ${footerClassName}`}>
            <div className={`footer-nav ${currentStep !== 1 ? "spread" : "end"}`}>
              ...
              <button onClick={isLastStep ? handleComplete : handleNext} className={classNameButtonNext} {...nextButtonProps}>
    ...
    <motion.div onClick={handleClick} className="step-indicator" animate={status} initial={false}>
      <motion.div
        variants={{
          ...
          active: { scale: 1, backgroundColor: "rgb(10 88 234)", color: "#5227FF" },
          complete: { scale: 1, backgroundColor: "rgb(10 88 234)", color: "#3b82f6" },
        }}
