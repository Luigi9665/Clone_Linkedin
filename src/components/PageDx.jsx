            ...
            <Row className="bg-white rounded mt-3  border border-secondary ">
              ...
              <Col className="d-flex align-items-center">
                ...
                <Col xs={8}>
                  ...
                  <Button variant="outline-dark" className=" buttonDx rounded-pill">
                    Visualizza
                  </Button>
                </Col>
              </Col>
            ...
            <Row className="bg-white rounded mt-3  border border-secondary ">
              ...
              <Col className="d-flex align-items-center">
                ...
                <Col xs={8}>
                  ...
                  <Button variant="outline-dark" className=" buttonDx rounded-pill d-flex align-items-center text-secondary fs-5 fw-semibold">
                    <PersonFillAdd className="fs-4 me-2" /> Collegati
                  </Button>
                </Col>
              </Col>
              {/* 2 */}
